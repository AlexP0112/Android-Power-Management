...
fun CPUFrequencyChart(
    ...
    val cpuFrequencyState = model.cpuFrequencyFlow.collectAsStateWithLifecycle(initialValue = mutableListOf())
    ...
    val dataPoints = cpuFrequencyState.value.mapIndexed { index, value ->
