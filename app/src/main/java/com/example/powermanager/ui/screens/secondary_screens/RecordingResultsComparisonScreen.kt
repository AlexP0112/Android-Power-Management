...
fun RecordingResultsComparisonScreen(
    ...
    Column(
        ...
        val minBatteryLevel = max(min(getListMinimum(leftBatteryValuesFloat), getListMinimum(rightBatteryValuesFloat)) - 100f, 0f)
        val maxBatteryLevel = max(getListMaximum(leftBatteryValuesFloat), getListMaximum(rightBatteryValuesFloat)) + 100f
        val minThreadCount = min(getListMinimum(leftThreadCountValuesFloat), getListMinimum(rightThreadCountValuesFloat)) - 100f
        val maxThreadCount = max(getListMaximum(leftThreadCountValuesFloat), getListMaximum(rightThreadCountValuesFloat)) + 100f
