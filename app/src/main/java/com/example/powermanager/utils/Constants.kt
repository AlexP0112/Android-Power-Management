...
const val CPUIDLE_EXPLANATION_SCREEN_NAME           = "_cpuidle"
...
const val CURRENT_CPUIDLE_GOVERNOR_PATH = "/sys/devices/system/cpu/cpuidle/current_governor_ro"
const val AVAILABLE_SCALING_GOVERNORS_PATH = "/sys/devices/system/cpu/cpu0/cpufreq/scaling_available_governors"
const val AVAILABLE_CPUIDLE_GOVERNORS_PATH = "/sys/devices/system/cpu/cpuidle/available_governors"
const val ONLINE_CORES_PATH = "/sys/devices/system/cpu/online"
...
const val CHANGE_CPUIDLE_GOVERNOR_COMMAND = "su -c echo %s > /sys/devices/system/cpu/cpuidle/current_governor"
